...
@section('title', 'Blog Details - Dinevo')
...
@section('content')
      ...
      <section class="blog-one-details section section-padding">
        <div class="container">
          <div class="row gy-5 g-xl-5 justify-content-center">
            <div class="col-12">
              <div class="blog-one-details__wrapper">
                <div class="blog-one-details__single v5">
                  <div class="blog-content-area">
                    <div class="blog-thumb">
                      <img
                        src="{{ asset('assets/images/patisserie/blog-details/main-thumb.png') }}"
                        alt="blog thumb"
                    ...
                    <div class="blog-content">
                      <div class="blog-details-meta">
                        <div class="author">
                          <img
                            src="{{ asset('assets/images/patisserie/blog-details/author.png') }}"
                            alt="author"
                          />
                          <span class="author-name">DIANNE</span>
                        </div>
                        <span class="meta-separator"></span>
                        <span class="meta-category">Healthy Food</span>
                        <span class="meta-separator"></span>
                        <span class="meta-comments">
                          ...
                          >
                            <path
                              d="M4.16797 9.16602H11.8346V8.16602H4.16797V9.16602ZM4.16797 7.16602H11.8346V6.16602H4.16797V7.16602ZM4.16797 5.16602H11.8346V4.16602H4.16797V5.16602ZM14.3346 14.025L11.9756 11.666H2.87314C2.53636 11.666 2.2513 11.5493 2.01797 11.316C1.78464 11.0827 1.66797 10.7976 1.66797 10.4608V2.87118C1.66797 2.5344 1.78464 2.24935 2.01797 2.01602C2.2513 1.78268 2.53636 1.66602 2.87314 1.66602H13.1295C13.4662 1.66602 13.7513 1.78268 13.9846 2.01602C14.218 2.24935 14.3346 2.5344 14.3346 2.87118V14.025ZM2.87314 10.666H12.4013L13.3346 11.5892V2.87118C13.3346 2.81985 13.3132 2.77285 13.2705 2.73018C13.2278 2.6874 13.1808 2.66602 13.1295 2.66602H2.87314C2.8218 2.66602 2.7748 2.6874 2.73214 2.73018C2.68936 2.77285 2.66797 2.81985 2.66797 2.87118V10.4608C2.66797 10.5122 2.68936 10.5592 2.73214 10.6018C2.7748 10.6446 2.8218 10.666 2.87314 10.666Z"
                              fill="currentColor"
                            />
                          </svg>
                          0 Comments
                      ...
                      <h2 class="blog-details-title">
                        French patisserie is known for its precision, elegance,
                        and rich flavors. From flaky
                      </h2>

                      <p class="blog-details-text">
                        The beauty of a patisserie lies in its attention to
                        detail. Skilled pastry chefs spend years perfecting
                        their techniques to ensure every dessert not only tastes
                        exceptional but also looks visually stunning. The
                        combination of texture, aroma, and presentation.
                      </p>
                      <p class="blog-details-text v2">
                        In today’s modern world, patisseries are evolving by
                        blending classic recipes with contemporary flavors.
                        Seasonal fruits, premium chocolate, and creative.
                      </p>

                      <div class="row g-4 align-items-center">
                        <div class="col-md-6 col-lg-12 col-xl-6">
                          <h3 class="inner-title">
                            flavors. From flaky croissants to delicate macarons
                          </h3>
                          <p class="blog-details-text">
                            Whether you are celebrating a special occasion or
                            simply treating yourself, a visit to a patisserie
                            offers a moment of joy and indulgence. With a wide
                            range of cakes, pastries, and artisan desserts.
                          </p>
                          ...
                          <ul class="check-list">
                            <li>
                              ...
                              <span class="text">Fresh Ingredients Daily</span>
                            </li>
                            <li>
                              <span class="icon">
                                <svg
                              ...
                              <span class="text"
                                >Hygiene-Focused Cloud Kitchen</span
                              >
                            </li>
                            <li>
                              <span class="icon">
                              ...
                              <span class="text"
                                >Multi-Cuisine Food Options</span
                              >
                            </li>
                          </ul>
                        </div>
                        <div class="col-md-6 col-lg-12 col-xl-6">
                          <img
                            src="{{ asset('assets/images/patisserie/blog-details/thumb-1.png') }}"
                            alt="inner image"
                      ...
                      <p class="blog-details-text mt-35">
                        A patisserie is more than just a place for desserts—it
                        is where art meets flavor. Every pastry is carefully
                        crafted with precision, passion, and high-quality
                        ingredients to create a delightful experience for the
                        senses. From buttery croissants to rich chocolate
                        éclairs, each creation reflects a balance of tradition
                        and innovation that defines the world of fine baking.
                      </p>
                      <p class="blog-details-text v2">
                        The beauty of a patisserie lies in its attention to
                        detail. Skilled pastry chefs spend years perfecting
                        their techniques to ensure every dessert not only tastes
                        exceptional but also looks visually stunning. The
                        combination of texture, aroma, and presentation turns
                        simple ingredients.
                      </p>

                      <h3 class="inner-title">
                        The right coffee can elevate the taste of any pastry.
                        Learn how to pair espresso, cappuccino, or latte with
                        your favorite desserts.
                      </h3>

                      <p class="blog-details-text v3">
                        Walking into a patisserie is like entering a world of
                        elegance and indulgence. The aroma of freshly baked
                        pastries, the delicate display of handcrafted desserts,
                        and the warm ambiance create an experience that goes
                        beyond taste. Every detail is designed to make each
                        visit memorable and comforting.
                      </p>

                      <div class="row g-4">
                        <div class="col-md-6 col-lg-12 col-xl-6">
                          <img
                            src="{{ asset('assets/images/patisserie/blog-details/thumb-2.png') }}"
                            alt="inner image"
                            class="img-fluid w-100"
                          />
                        </div>
                        <div class="col-md-6 col-lg-12 col-xl-6">
                          <img
                            src="{{ asset('assets/images/patisserie/blog-details/thumb-3.png') }}"
                            alt="inner image"
                            class="img-fluid w-100"
                          />
                        </div>
                      ...
                      <p class="blog-details-text mt-30">
                        At the heart of every great patisserie is a commitment
                        to quality. Using the finest ingredients such as rich
                        butter, fresh cream, and high-grade chocolate ensures
                        that every bite delivers a perfect balance of flavor and
                        texture. This dedication to excellence is what sets
                        artisan.
                      </p>

                      <p class="blog-details-text">
                        Presentation plays a vital role in the world of
                        patisserie. Each dessert is carefully designed to be
                        visually appealing, often resembling a piece of art.
                        From glossy glazes to delicate toppings, the aesthetic
                        beauty enhances the overall experience and makes every
                        treat feel special.
                      </p>

                      <div class="blog-details-footer">
                        <div class="tags">
                          <a href="{{ route('blog.details') }}">Fast Food</a>
                          <a href="{{ route('blog.details') }}">Pasta</a>
                          <a href="{{ route('blog.details') }}">Fast Food</a>
                        </div>
                  ...
                  <div class="post-author">
                    <div class="author-thumb">
                      <img
                        src="{{ asset('assets/images/patisserie/blog-details/author-main.png') }}"
                        alt="author"
                        class="img-fluid"
                      />
                    </div>
                    <div class="author-info">
                      ...
                      <span class="designation">Masterchef</span>
                      <p class="description">
                        "A true coffee lover’s paradise! From latte art to
                        freshly roasted beans, every detail is crafted with
                        care. Highly recommend to anyone who appreciates quality
                        coffee."
                      </p>
                    </div>
                  </div>
                ...
                <div class="widget-one_sidebar">
                  ...
                  <div class="widget v5 widget__tags">
                    ...
                    <div class="tag-list">
                      <a class='tag-btn' href="{{ route('blog.details') }}">French Pastry</a
                      >
                      <a class='tag-btn' href="{{ route('blog.details') }}">Desserts</a>
                      <a class='tag-btn' href="{{ route('blog.details') }}">temaki</a>
                      <a class='tag-btn' href="{{ route('blog.details') }}">cafe</a>
                      <a class='tag-btn' href="{{ route('blog.details') }}">Best Seller</a
                      >
                      <a class='tag-btn' href="{{ route('blog.details') }}">Sweet Moments</a
                      >
                      <a class='tag-btn' href="{{ route('blog.details') }}">Pastry Art</a
                      >
                      <a class='tag-btn' href="{{ route('blog.details') }}">fusion sushi</a
                      >
                      <a class='tag-btn' href="{{ route('blog.details') }}">sushi chef</a
                      >
                      <a class='tag-btn' href="{{ route('blog.details') }}">cakes</a>
                    </div>
                  </div>
                  <div
